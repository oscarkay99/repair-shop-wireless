...
import { Clock, Trash2, UserPlus, X, RefreshCw } from 'lucide-react';
...
export default function TechniciansPage() {
  ...
  const { technicians, loading, add, remove } = useTechnicians();
                  ...
                  <div className="flex items-start gap-4 mb-4">
                    <div className="relative flex-shrink-0">
                      ...
                      <span className="absolute bottom-0.5 right-0.5 w-3 h-3 rounded-full border-2 border-[hsl(var(--card))]"
                        style={{ background: isActive ? 'hsl(var(--primary))' : 'hsl(var(--muted-foreground))' }} />
                    </div>
