    ...
    <div className="rounded-2xl p-5 text-white" style={{ background: 'linear-gradient(180deg, #0F172A 0%, #DC1F1F 100%)' }}>
      <div className="flex items-center gap-2 mb-4">
        ...
        <div className="ml-auto">
          <div className="w-10 h-10 bg-[hsl(var(--card))]/10 rounded-lg flex items-center justify-center">
            <i className="ri-qr-code-line text-white/60 text-xl" />
          </div>
        </div>
      </div>

      <div className="bg-[hsl(var(--card))]/5 rounded-xl p-3 mb-3">
      ...
      <div className="grid grid-cols-2 gap-2 mb-3">
        <div className="bg-[hsl(var(--card))]/5 rounded-xl p-3">
      ...
      {cert.batteryHealth < 100 && (
        <div className="bg-[hsl(var(--card))]/5 rounded-xl p-3 mb-3">
          ...
          <div className="h-1.5 bg-[hsl(var(--card))]/10 rounded-full">
            <div className="h-full bg-amber-400 rounded-full" style={{ width: `${cert.batteryHealth}%` }} />
          </div>
        </div>
      )}

      <div className="bg-[hsl(var(--card))]/5 rounded-xl p-3 mb-4">
      ...
      <div className="flex gap-2 mt-4">
        <button className="flex-1 py-2 rounded-xl bg-[hsl(var(--card))]/10 hover:bg-[hsl(var(--card))]/20 text-xs text-white cursor-pointer whitespace-nowrap">
