...
let localStore: WirelessRole[] = [
  ...
  { id: 'sales_manager', name: 'Sales Manager', color: '#F59E0B', is_system: false, scope_tickets_to_technician: false, dashboard_variant: 'sales_manager', created_at: now(), updated_at: now(),
    permissions: ['tickets:view','tickets:edit','ticket_media:view','ticket_comments:view','ticket_parts:view','ticket_parts:create','customers:create','customers:edit','customers:delete','invoices:create','invoices:edit','invoices:delete','invoices:items_edit','technicians:edit','parts:edit','sales:create','payments:create','team:view','audit_logs:view'] },
  ...
  { id: 'receptionist', name: 'Receptionist', color: '#8B5CF6', is_system: false, scope_tickets_to_technician: false, dashboard_variant: 'receptionist', created_at: now(), updated_at: now(),
    permissions: ['tickets:view','tickets:create','tickets:edit','ticket_media:view','ticket_comments:view','ticket_parts:view','customers:create','customers:edit','invoices:create','invoices:edit','payments:create'] },
];
